...
def parse_arguments():
	...
	arg_parser.add_argument('--input-path', required=True, help='path to Universal Dependencies treebank directory')
	arg_parser.add_argument('--task', required=True, choices=['relations', 'pos'], help='task identifier')
	arg_parser.add_argument('--out-path', required=True, help='path to CSV output directory')
